...
**本番最新 deploy**: 2026-05-05 build `19:35:04` ([`9b3f2ff`](https://github.com/sogebu/LorentzArena/commit/9b3f2ff))。
...
**Bug 11 (3 軸直交 fix + (a) layer 対称性 + (c) HUD UI + Stage 8 根本治療 全 deploy 済 build `19:35:04`) — production sleep-wake verify ✅ confirmed (前 build まで)**:
...
- mesh-ish recovery は (d) で sleep-wake が解消しなければ別 plan で着手判断
