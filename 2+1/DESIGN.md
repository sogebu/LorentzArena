...
**透明度と両面可視**: surface 0.05 / wireframe 0.06 / PastConeLoop 0.55。surface は `THREE.DoubleSide` (光円錐と同じ扱い、カメラが円柱の内側にあっても裏面から側面が見える)。本体は極薄くして交線で中心情報を与える。色は中性 (白)、プレイヤー色や LH 色と干渉しない。
